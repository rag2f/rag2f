...
class Spock:
    ...
    def load(self) -> None:
        ...
        logger.debug("Final config structure: rag2f keys=%s, plugins=%s",
    ...
    def get_rag2f_config(self, key: Optional[str] = None, default: Any = None) -> Any:
    ...
    def get_plugin_config(self, plugin_id: str, key: Optional[str] = None, default: Any = None) -> Any:
