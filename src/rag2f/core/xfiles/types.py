...
DocumentId: TypeAlias = Union[str, bytes]
...
CoreComparisonOp: TypeAlias = Literal["eq", "ne", "gt", "gte", "lt", "lte", "in"]

#: Logical operators for combining conditions
LogicalOp: TypeAlias = Literal["and", "or", "not"]

#: Extended string operators (optional, declared via capabilities)
StringOp: TypeAlias = Literal["contains", "startswith", "endswith", "regex"]

#: Other extended operators (optional, declared via capabilities)
ExtendedOp: TypeAlias = Literal["exists", "fulltext", "near", "within"]

#: All supported operator types
WhereOp: TypeAlias = Union[CoreComparisonOp, LogicalOp, StringOp, ExtendedOp]
